...
if (isset($_POST["submit"])) {
  ...
  if(empty($nameErr) && empty($emaileErr) && empty($bodyErr)){
    //add to database
...
<img src="/bigcoffeefeedback/img/big-coffee.png" class="w-25 mb-3" alt="img-of-big-coffee">
<h2>Feedback</h2>
<p class="lead text-center">Leave feedback for Big Coffee</p>
